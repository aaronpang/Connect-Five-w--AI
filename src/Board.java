public class Board
{
	...
	{
		{
			...
			// boardDebugger();
			// board[0][0] = -1;
			// System.out.println("lastRow " + lastRow + "  lastColumn "
			// + lastColumn);
			// System.out.println("board length " + board.length + "  width "
			// + board[1].length);
			// System.out.println("Piece " + board[lastRow][lastColumn]);
	...
	public void AIdebugger()
	{
		for (int i = 1; i <= 15; i++)
		{
			for (int o = 1; o <= 15; o++)
			{
				if (pointBoard[i][o] >= 100)
					System.out.print(pointBoard[i][o] + " ");
				else if (pointBoard[i][o] >= 10)
					System.out.print(pointBoard[i][o] + "  ");
				else
					System.out.print(pointBoard[i][o] + "   ");
			}
	 ...
	 * Debugging the point board for the AI system
	 */
	public void debugBoarder()
	{
		for (int i = 1; i <= 15; i++)
		{
			for (int o = 1; o <= 15; o++)
			{
				if (debugBoard[i][o] >= 100)
					System.out.print(debugBoard[i][o] + " ");
				else if (debugBoard[i][o] >= 10)
					System.out.print(debugBoard[i][o] + "  ");
				else
					System.out.print(debugBoard[i][o] + "   ");
			}
	 ...
	 * @param difficulty
	 *        The level of computer AI. Level 3 is the highest, thus using the
	 *        most checks and finds a better move than a Level 1.
	...
	public int[] AIchecker(int difficulty)
	{
		...
		debugBoard = new int[row][column];
		int i = 0;
		// Use an array to return both the row and column of the highest points
		// location.
		int[] position = new int[2];
		int[] positionForWin = new int[2];
		position[0] = 1;
		position[1] = 1;
		positionForWin[0] = 1;
		positionForWin[1] = 1;

		// The number of pieces found in a row. Used to check Player pieces to
		// block.
		int pieceCount = 0;
		// The number of pieces found in a row. Used to check for the computer
		// pieces to expand.
		int pieceCountTwo = 0;
		...
		// computer.
		boolean playerCanWinNextTurnSoThisIsTrue = false;
		boolean compHasAChainOfThree = false, whenTheComputerCanWinThisIsTrue = false;
		...
		for (int rowCount = 1; rowCount <= 15; rowCount++)
		{
			...
			{
				i++;
				debugBoard[rowCount][columnCount] = i;
				...
				if (board[rowCount][columnCount] == 0)
				{
					...
					while (board[lastRow][lastColumn] == 2)
					{
						...
						{
							points += 500;
							playerCanWinNextTurnSoThisIsTrue = true;
							System.out
									.println("playerCanWinNextTurnSoThisIsTrue: "
											+ playerCanWinNextTurnSoThisIsTrue);
						}
					...
					if (difficulty == 3 && pieceCount == 3)
					{
						if (columnCount <= 12
								...
								&& board[rowCount][columnCount + 1] == 2
								&& board[rowCount][columnCount + 2] == 2
								&& board[rowCount][columnCount + 3] == 2
								|| columnCount <= 13
					...
					while (board[lastRow][lastColumn] == 2)
					{
						...
						if (pieceCount == 4)
						{
							...
							playerCanWinNextTurnSoThisIsTrue = true;
							System.out
									.println("playerCanWinNextTurnSoThisIsTrueS: "
											+ playerCanWinNextTurnSoThisIsTrue);
						}
					...
					if (difficulty == 3 && pieceCount == 3)
					{
						if (rowCount <= 12 && board[rowCount][columnCount] == 0
								...
								&& board[rowCount + 3][columnCount] == 2
								&& board[rowCount + 2][columnCount] == 2
								&& board[rowCount + 1][columnCount] == 2
								|| rowCount <= 13
					...
					if (difficulty == 3 && pieceCount == 3)
					{
						if (rowCount <= 12 && columnCount >= 4
								...
								&& board[rowCount + 3][columnCount - 3] == 2
								&& board[rowCount + 2][columnCount - 2] == 2
								&& board[rowCount + 1][columnCount - 1] == 2
					...
					if (difficulty == 3 && pieceCount == 3)
					{
						if (rowCount >= 4 && columnCount >= 4
								...
								&& board[rowCount + 1][columnCount + 1] == 0
								&& board[rowCount - 3][columnCount - 3] == 0
								&& board[rowCount - 2][columnCount - 1] == 2
								&& board[rowCount - 1][columnCount - 2] == 2
				...
				if (points > highestPoints)
				{
					...
					System.out.println("highestRow " + highestRow
				...
				if (board[rowCount][columnCount] == 0)
				{
					// System.out.println("isFourChain: " + isFourChain);
					...
					while (board[lastRow][lastColumn] == 1)
					{
						pieceCountTwo++;
						lastColumn++;
						System.out.println("1  " + lastRow + "  " + lastColumn);
						System.out.println("pieceCountTwo " + pieceCountTwo);
					}
					...
					while (board[lastRow][lastColumn] == 1)
					{
						pieceCountTwo++;
						lastColumn--;
						System.out.println("2  " + lastRow + "  " + lastColumn);
						System.out.println("pieceCountTwo " + pieceCountTwo);
					}
					...
					// 4-chains.
					if (pieceCountTwo == 3 && highestPoints < 233
							&& !playerCanWinNextTurnSoThisIsTrue)
						if (columnCount <= 12
								&& board[rowCount][columnCount] == 0
								&& board[rowCount][columnCount + 4] == 0
								...
								&& board[rowCount][columnCount] == 0)
						{
							...
							System.out.println("COLUMNCOUNT 1  " + columnCount);
							position[0] = rowCount;
							position[1] = columnCount;
							compHasAChainOfThree = true;
						}
					...
					if (pieceCountTwo >= 4)
					{
						...
						System.out.println("\n  pieceCountTwo  "
								+ pieceCountTwo + "\n");
						System.out.println("ROWCOUNT 1  " + rowCount);
						positionForWin[0] = rowCount;
						positionForWin[1] = columnCount;
						System.out.println("rowCount: " + rowCount
								+ "  columnCount: " + columnCount);
						whenTheComputerCanWinThisIsTrue = true;
					}
					...
					if (pieceCountTwo >= 4)
					{
						System.out.println("                PieceCountTwo "
								+ pieceCountTwo);
					}
					...
					if (pieceCountTwo == 3 && highestPoints < 233
						...
						if (rowCount <= 12 && columnCount >= 4
								...
								&& board[rowCount][columnCount] == 0)
						{
							System.out.println("ROWCOUNT 3  " + rowCount);
							position[0] = rowCount;
							position[1] = columnCount;
							System.out.println("rowCount: " + rowCount
									+ "  columnCount: " + columnCount);
					...
					if (pieceCountTwo == 3 && highestPoints < 233
						...
						if (rowCount >= 4 && columnCount >= 4
								...
								&& board[rowCount][columnCount] == 0)
						{
							System.out.println("ROWCOUNT 4  " + rowCount);
							position[0] = rowCount;
							position[1] = columnCount;
							System.out.println("rowCount: " + rowCount
									+ "  columnCount: " + columnCount);
					...
					if (whenTheComputerCanWinThisIsTrue)
					{
		...
		System.out.println("\nplayerCanWinNextTurnSoThisIsTrue: "
				+ playerCanWinNextTurnSoThisIsTrue);
		System.out.println("\nwhenTheComputerCanWinThisIsTrue: "
				+ whenTheComputerCanWinThisIsTrue);
		if (whenTheComputerCanWinThisIsTrue)
		{
			System.out.println("positionForWin[0] " + positionForWin[0]
					+ "  positionForWin[1] " + positionForWin[0]);
			return positionForWin;
		}
		if (compHasAChainOfThree && !playerCanWinNextTurnSoThisIsTrue)
		{
			System.out.println("Player: " + playerCanWinNextTurnSoThisIsTrue);
			return position;
		}
		System.out.println("highestRow END " + highestRow
				+ "   highestColumn END " + highestColumn);
		position[0] = highestRow;
		position[1] = highestColumn;
		System.out.println("position[0] " + position[0] + "   position[1] "
				+ position[1]);
		return position;
