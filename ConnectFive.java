...
//
//      5... Assign point values to these moves and do the move with the highest overall point value. 
//      But those 4 should occur in that order no matter what otherwise the computer will not make the best move.
	 ...
	 */
	public ConnectFive() {
		bgMusic = Applet.newAudioClip(getCompleteURL("ssbm.wav"));
		...
		gameOverSound = Applet.newAudioClip(getCompleteURL("ff7victory.wav"));
		bgMusic.loop();
	...
	public void actionPerformed(ActionEvent event) {
		...
		// Displays copyright information if the about option is selected.
			...
			JOptionPane.showMessageDialog(this, "By: Aaron Pang and Brandon Ma"
					+ "  \u00A9 2010", "About",
	...
	public void computerTurn() {
		...
		// method, we check all the surrounding blocks to claculate the
